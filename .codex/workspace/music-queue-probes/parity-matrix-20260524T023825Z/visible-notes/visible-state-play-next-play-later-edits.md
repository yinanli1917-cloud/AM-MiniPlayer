...
context_label: play-next-play-later-edits
created_utc: 20260524T023825Z
manual_outcome: pending

## Manual Setup

- Required setup: Manually add at least two tracks using Music.app Play Next/Play Later.
- Expected proof: Probe must reflect the edited visible queue order.
