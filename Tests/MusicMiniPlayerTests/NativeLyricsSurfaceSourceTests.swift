...
final class NativeLyricsSurfaceSourceTests: XCTestCase {
    ...
    func testNativeSurfaceDoesNotHostSwiftUIRowViews() throws {
        ...
        XCTAssertTrue(source.contains("let containerScale = plan.scales.first ?? 1"))
        XCTAssertTrue(source.contains("dotContainerLayer.setAffineTransform(CGAffineTransform(scaleX: containerScale"))
        XCTAssertFalse(source.contains("dot.setAffineTransform(CGAffineTransform(scaleX: scale"))
        ...
        XCTAssertTrue(metricsSource.contains("let targetBreatheDuration: TimeInterval = 1.5"))
        XCTAssertTrue(metricsSource.contains("if currentDuration < 0.5"))
        XCTAssertTrue(metricsSource.contains("globalOpacity *= clamp01(CGFloat(remaining / 0.375))"))
        XCTAssertFalse(metricsSource.contains("let dotsActiveDuration = max(0.1, totalDuration - fadeOutDuration)"))
        XCTAssertFalse(metricsSource.contains("fadeOutProgress * 8"))
