 ...
 *           to glassEffect).
 * [POS]: Spike v11 (2026-09-22). Replaces two system glass bodies blended by
 *        GlassEffectContainer: the system's merge shapes and highlights
 *        showed through, and system glass can never be pure black.
...
public enum LiquidOutline {
    ...
    @inline(__always)
    static func sdf(_ x: Double, _ y: Double, cx: Double, cy: Double, hx: Double, hy: Double, r: Double) -> Double {
