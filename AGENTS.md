...
_Migrated from Claude Code `/Users/yinanli/Documents/MusicMiniPlayer/CLAUDE.md` on 2026-05-03. The source `CLAUDE.md` was left unchanged._
...
| Path | Purpose |
|------|---------|
| `.agents/harness/README.md` | Harness architecture and operating rules |
| `.agents/harness/rules.yaml` | Project deny rules, protected UX, verification gates |
...
| `.agents/skills/` | Repo-local Codex skills migrated from Claude skills where applicable |
